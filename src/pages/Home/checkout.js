...
class becomeExpert extends React.Component {
  ...
  stateChange = async(e) => {
    ...
    sessionStorage.setItem("amount",this.state.paypal)
  };

  payment = async () => {
    let body = new FormData();
    body.append("user_ID", localStorage.getItem("user_id"));
    body.append("paid", sessionStorage.getItem("paid"));
    body.append("amount", localStorage.getItem("amount"));
    body.append("payerID", sessionStorage.getItem("payerID"));
    body.append("paymentID", sessionStorage.getItem("paymentID"));
    body.append("receiver_id", localStorage.getItem("userchatuId"));
    body.append("package", this.state.paypal);
  ...
  componentDidMount = async () => {
    ...
    body.append("id", localStorage.getItem("userchatshower_id"));
                ...
                <div class="paypal-procedbtn">
                  ...
                  <Link to="/MyExpert">
                    <button
                      ...
                      disabled = {!sessionStorage.getItem("paymentID")}
                    >
                      Next
                    </button>
                  </Link>
