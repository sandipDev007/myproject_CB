...
class exProfileedit extends React.Component {
  constructor(props) {
    super();
  ...
  // coverpicChange = () => {
  //   this.props.history.push("/ExpertCoverImage");
  // };
  ...
  componentDidMount = async () => {
    if (
      ...
      this.props.history.push("/userblank");
    }
  ...
  handleSubmit = async () => {
    ...
    body.append("expertise", this.state.expertise);
  ...
  EditExInterest = () => {
    this.props.history.push("/EditExInterest");
  };

  EditExExpertise = () => {
    this.props.history.push("/EditExExpertise");
  };
                    ...
                    <Col md="12" sm="12">
                      <Form.Group controlId="validationlast">
                        <InputGroup className="flex-nowrap">
                          ...
                          <img className="addinterest-icon" src={require("../../assest/images/add.png")} alt="" onClick={this.EditExInterest} />
                        ...
                        <InputGroup className="flex-nowrap">
                          ...
                          <small className="d-block text-capitalized tadd">
                            <Form.Control
                              name="expertise"
                              type="text"
                              value={this.state.expertise} readOnly
                              onChange={this.handleChange}
                            />
                          </small>
                          <img className="addinterest-icon" src={require("../../assest/images/add.png")} alt="" onClick={this.EditExExpertise} />
