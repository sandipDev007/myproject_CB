...
class ProfileEdit extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    await axios
      ...
      .then(res => {
        ...
        if (localStorage.getItem("expertType") == "C") {
  ...
  handleSubmit = async () => {
    ...
    body.append("type", this.state.Employment);
    ...
    body.append("institute_logo", "");
    body.append("expert_type", localStorage.getItem("expertType"))
