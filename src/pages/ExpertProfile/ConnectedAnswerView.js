...
class exProfile extends React.Component {
    ...
    componentDidMount = async () => {
        ...
        body1.append("user_id", localStorage.getItem("userchatuId"));
                                                    ...
                                                    <div className="allQuestion">
                                                        ...
                                                        <div className="userAns">
                                                            <div className="user-pic">
                                                                ...
                                                                <h4>{item.answers.name} <br></br><span>{item.answers.timeStamp}</span></h4>
                                                            </div>
                                                            <p>
                                                                <ReadMoreReact
                        ...
                        <Col md={3} className="pl-md-0">
                            <div className="left-sidebar" id="sidebar2">
                                ...
                                <div className="right-ad">
                                    <img
                                        src={require("../../assest/images/hire-add.jpg")}
                                    ></img>
                                    <Link to="/expertlist">
