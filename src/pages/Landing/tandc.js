...
export default class tanndc extends Component {
            ...
            <Navbar collapseOnSelect expand="lg">
              ...
              <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="ml-auto">
                  ...
                  <Nav.Link href="/ouercontactUS">Contact Us</Nav.Link>
 ...
 Under these Terms of Service, so please read these terms of service carefully before using connectbud website &amp; app.</p>
                ...
                <Col md={4} sm={12}>
                  <div className="links">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li>
                        <a href="/outerconectUS">Contact Us</a>
                      </li>
                    </ul>
                  </div>
                </Col>
