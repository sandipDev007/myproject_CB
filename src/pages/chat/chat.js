    ...
    socket.on(
      ...
      function(ping) {
        ...
        if (chatbody != null) {
          ...
          else if (data.endsWith("pdf") == true) {
          ...
          else if (data.endsWith("xls") == true) {
            console.log("else if block called");
    ...
    await axios({
      ...
      .then(response => {
        ...
        if (response.data[0].message == "N") {
          this.props.history.push("/exnodata");
        } else {
              ...
              <Col md={8}>
                <div class="right-chat-details">
                  ...
                  <div class="chat-body" id="chatbody">
                    {/* <div className="chat-devider"> <span>Today</span></div> */}
                        ...
                        if 
                          ...
                          return (
                            <div class="ch-msg ch-left ch-leftdoc d-flex align-items-center">
                              ...
                              >
                                {" "}
                                {/* <a href={item.chatContent} download>ss */}
                                <img
                                  src={require("../../assest/images/testpdf.png")}
                                />
                                {/* </a> */}
